...
-- Note: This will create a notification for any existing user
-- In production, this would be handled by the admin panel or system events

-- Create a sample notification function for demo purposes
